...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    if (ex == LLAMA_EXAMPLE_COMPLETION) {
        ...
        const auto spec_default = common_speculative_default_config();
        params.speculative.types = spec_default.types;
        params.speculative.ngram_mod = spec_default.ngram_mod;
        params.speculative.spec_type_specified = false;
    } else if (ex == LLAMA_EXAMPLE_CLI) {
        const auto spec_default = common_speculative_default_config();
        params.speculative.types = spec_default.types;
        params.speculative.ngram_mod = spec_default.ngram_mod;
        params.speculative.spec_type_specified = false;
    ...
    add_opt(common_arg(
        ...
        string_format("comma-separated list of types of speculative decoding to remove (default: %s)\n",
            common_speculative_type_name_str(params.speculative.types).c_str()),
        [](common_params & params, const std::string & value) {
            const auto types_str = string_split<std::string>(value, ',');
            auto types = common_speculative_types_from_names(types_str);
